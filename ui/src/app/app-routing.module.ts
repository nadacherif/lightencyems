...
const routes: Routes = [
  ...
  },
  {
    path: 'exchange',
    data: { navbarTitle: environment.uiTitle },
    component: ExchangeMenuComponent,
    children: [
      { path: '', redirectTo: 'personal', pathMatch: 'full' },
      {
        path: 'personal',
        component: PersonalFormComponent,
        data: { stepTitle: 'Step 1' },
      },
      {
        path: 'buyer',
        component: BuyerFormComponent,
        data: { stepTitle: 'Step 2' },
      },
      {
        path: 'seller',
        component: SellerFormComponent,
        data: { stepTitle: 'Step 3' },
      },
      {
        path: 'confirmation',
        component: ConfirmationComponent,
        data: { stepTitle: 'Step 4' },
      },
    ],
  },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ':componentId/channelthresholdchart',
          ...
          {
            path: ':componentId/fixdigitaloutputchart',
            component: FixDigitalOutputChartOverviewComponent,
          },
          {
            path: ':componentId/gridOptimizedChargeChart',
            component: GridOptimizedChargeChartOverviewComponent,
          },
          {
            path: ':componentId/heatingelementchart',
            component: HeatingelementChartOverviewComponent,
          },
          {
            path: ':componentId/heatpumpchart',
            component: HeatPumpChartOverviewComponent,
          },
          {
            path: ':componentId/singlethresholdchart',
            component: SinglethresholdChartOverviewComponent,
          },
          {
          ...
          {
            path: ':componentId/timeOfUseTariffDischargeChart',
            component: TimeOfUseTariffDischargeChartOverviewComponent,
          },
          { path: 'autarchychart', component: AutarchyChartOverviewComponent },
          {
            path: 'consumptionchart',
            component: ConsumptionChartOverviewComponent,
          },
          { path: 'gridchart', component: GridChartOverviewComponent },
          {
            path: 'productionchart',
            component: ProductionChartOverviewComponent,
          },
          {
      ...
      {
        path: 'settings/profile/:componentId',
        component: AliasUpdateComponent,
      },
      {
        path: 'settings/systemexecute',
      ...
      { path: 'settings/systemlog', component: EdgeSettingsSystemLogComponent },
      {
        ...
        component: EdgeSettingsSystemUpdateComponent,
      },
      {
        path: 'settings/app',
        data: { navbarTitle: environment.edgeShortName + ' Apps' },
        component: EdgeSettingsAppIndex,
      },
      {
        path: 'settings/app/install/:appId',
        component: EdgeSettingsAppInstall,
      },
      {
        path: 'settings/app/install/:appId',
        component: EdgeSettingsAppInstall,
